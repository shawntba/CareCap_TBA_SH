//
//  ShareKitCareCapConfigurator.m
//  CareCap
//
//  Created by Tba-Sh-Apple on 8/16/12.
//
//

#import "ShareKitCareCapConfigurator.h"

@implementation ShareKitCareCapConfigurator
...
- (NSString*)twitterConsumerKey {
	return @"wGpm9GoQ1KqooQb80gg";
}

- (NSString*)twitterSecret {
	return @"ZEVe7quULaL0hfOV3bDdrWeryRPIlfp0LdEtDBXE";
}
// You need to set this if using OAuth, see note above (xAuth users can skip it)
- (NSString*)twitterCallbackUrl {
	return @"http://www.thebeaglearmada.nl";
}
...
- (NSString*)bitLyKey {
	return @"R_db5d040575c0c941c12ed1bce8e26f99";
}
...
- (NSString*)sharersPlistName {
    return [[NSBundle mainBundle] pathForResource:@"CareCapSharers" ofType:@"plist"];
}
...
- (NSArray*)defaultFavoriteURLSharers {
    return [NSArray arrayWithObjects:@"SHKTwitter",@"SHKFacebook",@"SHKLinkedIn",@"SHKMail",@"SHKTextMessage", nil];
}
